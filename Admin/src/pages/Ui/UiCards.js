...
import { Col, Row, Card, CardBody, CardTitle, CardSubtitle, CardImg, CardText, CardHeader, CardImgOverlay, CardFooter, CardColumns, Container, CardGroup } from "reactstrap";
                        ...
                        <Row>
                            <Col lg={4}>
                                <Card color="primary" className="text-white-50">
                                    <CardBody>
                                        <h5 className="mb-4 text-white"><i className="mdi mdi-bullseye-arrow me-3"></i> Primary Card</h5>
                            ...
                            <Col lg={4}>
                                <Card color="success" className="text-white-50">
                                    <CardBody>
                                        <h5 className="mb-4 text-white"><i className="mdi mdi-check-all me-3"></i> Success Card</h5>
                                        <CardText>Some quick example text to build on the card title and make up the bulk of the card's content.</CardText>
                                    </CardBody>
                                </Card>
                            </Col>
                            ...
                            <Col lg={4}>
                                <Card color="info" className="text-white-50">
                                    <CardBody>
                                        <h5 className="mb-4 text-white"><i className="mdi mdi-alert-circle-outline me-3"></i>Info Card</h5>
                                        <CardText>Some quick example text to build on the card title and make up the bulk of the card's content.</CardText>
                                    </CardBody>
                                </Card>
                            </Col>
                        ...
                        <Row>
                            ...
                            <Col lg={4}>
                                <Card color="dark" className="text-light">
                                    <CardBody>
                                        <h5 className="mb-4 text-white"><i className="mdi mdi-alert-circle-outline me-3"></i>Dark Card</h5>
                                        <CardText>Some quick example text to build on the card title and make up the bulk of the card's content.</CardText>
                                    </CardBody>
                                </Card>
                            </Col>
                            ...
                            <Col sm={12}>
                                ...
                                <CardColumns>
                                    ...
                                    <Card color="primary" className="text-white text-center p-3">
                                        <blockquote className="card-blockquote text-right  mb-0">
